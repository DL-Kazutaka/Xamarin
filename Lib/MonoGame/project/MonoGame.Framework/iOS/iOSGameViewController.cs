...
namespace Microsoft.Xna.Framework {
	class iOSGameViewController : UIViewController {
        ...
        /// <summary>
        /// Gets the interface orientation.
        /// 角度は、ゲームのSupportedOrientations を参照するように上書き
        /// </summary>
        /// <value>The interface orientation.</value>
        public override UIInterfaceOrientation InterfaceOrientation {
            get {
                try {
                    if (_platform !=null && _platform.Game !=null && _platform.Game.graphicsDeviceManager != null) {
                        if (_platform.Game.graphicsDeviceManager.SupportedOrientations == DisplayOrientation.Portrait)
                            return UIInterfaceOrientation.Portrait;
                        return UIInterfaceOrientation.LandscapeRight;
                    }
                } catch {
                }
                return base.InterfaceOrientation;
            }
        }
